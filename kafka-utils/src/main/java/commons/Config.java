...
public class Config {
    ...
    private static String CONSUMER_CONF="kafka-consumer-client.properties";
    private static String PRODUCER_CONF="kafka-producer-client.properties";
    ...
    public static Properties getConsumerProperties() {
        return getProperties(CONSUMER_CONF);
    }
    ...
    public static Properties getProducerProperties() {
        return getProperties(PRODUCER_CONF);
    }
